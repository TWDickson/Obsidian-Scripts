...
function getFallbackJournalThoughtModalCss(extraCss = '') {
    return `
        /* Layout */
...
async function start(params, settings) {
    ...
    const getJournalThoughtModalCss = sharedStyles?.getJournalThoughtModalCss ?? getFallbackJournalThoughtModalCss;
